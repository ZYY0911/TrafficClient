...
import com.mad.trafficclient.activity.SpActivity;

/**
 * @Login Name win10
 * @Create by 张瀛煜 on 2020/9/29 at 9:10
 */
public class WzspFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.wzsp_fragment, container, false);
